    ...
    return (
        <ResponsiveContainer width="100%" height="90%">
            <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 0 }}>
                ...
                <XAxis type="number" dataKey="x" name="Frequency" tickFormatter={v => v.toLocaleString('en-US')} label={{ value: 'Frequency', position: 'bottom', offset: 0, fontSize: 10 }} tick={{ fontSize: 10 }} />
